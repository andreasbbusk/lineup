...
const models: TsoaRoute.Models = {
    "UserProfile": {"dataType":"refObject","properties":{"id":{"dataType":"string","required":true},"username":{"dataType":"string","required":true},"firstName":{"dataType":"string","required":true},"lastName":{"dataType":"string","required":true},"avatarUrl":{"dataType":"string"},"bio":{"dataType":"string"},"aboutMe":{"dataType":"string"},"phoneCountryCode":{"dataType":"double"},"phoneNumber":{"dataType":"double"},"yearOfBirth":{"dataType":"double"},"location":{"dataType":"string","required":true},"userType":{"dataType":"string","required":true},"themeColor":{"dataType":"string"},"spotifyPlaylistUrl":{"dataType":"string"},"onboardingCompleted":{"dataType":"boolean","required":true},"createdAt":{"dataType":"string","required":true},"updatedAt":{"dataType":"string","required":true}},"additionalProperties":false},
    "UpdateProfileDto": {"dataType":"refObject","properties":{"firstName":{"dataType":"string"},"lastName":{"dataType":"string"},"bio":{"dataType":"string"},"aboutMe":{"dataType":"string"},"avatarUrl":{"dataType":"string"},"location":{"dataType":"string"},"themeColor":{"dataType":"string"},"spotifyPlaylistUrl":{"dataType":"string"},"phoneCountryCode":{"dataType":"double"},"phoneNumber":{"dataType":"double"},"onboardingCompleted":{"dataType":"boolean"}},"additionalProperties":false},
    ...
    "PostRow": {"dataType":"refAlias","type":{"dataType":"nestedObjectLiteral","nestedProperties":{"updated_at":{"dataType":"union","subSchemas":[{"dataType":"string"},{"dataType":"enum","enums":[null]}],"required":true},"type":{"dataType":"union","subSchemas":[{"dataType":"enum","enums":["note"]},{"dataType":"enum","enums":["request"]},{"dataType":"enum","enums":["story"]}],"required":true},"title":{"dataType":"string","required":true},"search_vector":{"dataType":"any","required":true},"paid_opportunity":{"dataType":"union","subSchemas":[{"dataType":"boolean"},{"dataType":"enum","enums":[null]}],"required":true},"location":{"dataType":"union","subSchemas":[{"dataType":"string"},{"dataType":"enum","enums":[null]}],"required":true},"id":{"dataType":"string","required":true},"expires_at":{"dataType":"union","subSchemas":[{"dataType":"string"},{"dataType":"enum","enums":[null]}],"required":true},"description":{"dataType":"string","required":true},"created_at":{"dataType":"union","subSchemas":[{"dataType":"string"},{"dataType":"enum","enums":[null]}],"required":true},"author_id":{"dataType":"string","required":true}},"validators":{}}},
    "PostResponse": {"dataType":"refAlias","type":{"dataType":"intersection","subSchemas":[{"ref":"PostRow"},{"dataType":"nestedObjectLiteral","nestedProperties":{"author":{"dataType":"any"},"tagged_users":{"dataType":"array","array":{"dataType":"any"}},"media":{"dataType":"array","array":{"dataType":"any"}},"metadata":{"dataType":"array","array":{"dataType":"any"}}}}],"validators":{}}},
    ...
    "MediaItemDto": {"dataType":"refObject","properties":{"url":{"dataType":"string","required":true},"thumbnail_url":{"dataType":"string"},"type":{"dataType":"string","required":true}},"additionalProperties":false},
    ...
    "CreatePostBody": {"dataType":"refObject","properties":{"description":{"dataType":"string","required":true},"expires_at":{"dataType":"union","subSchemas":[{"dataType":"string"},{"dataType":"enum","enums":[null]}]},"location":{"dataType":"union","subSchemas":[{"dataType":"string"},{"dataType":"enum","enums":[null]}]},"paid_opportunity":{"dataType":"union","subSchemas":[{"dataType":"boolean"},{"dataType":"enum","enums":[null]}]},"title":{"dataType":"string","required":true},"type":{"ref":"PostType","required":true},"tags":{"dataType":"array","array":{"dataType":"string"}},"genres":{"dataType":"array","array":{"dataType":"string"}},"taggedUsers":{"dataType":"array","array":{"dataType":"string"}},"media":{"dataType":"array","array":{"dataType":"refObject","ref":"MediaItemDto"}}},"additionalProperties":false},
    ...
    "MetadataItem": {"dataType":"refObject","properties":{"id":{"dataType":"string","required":true},"type":{"dataType":"union","subSchemas":[{"dataType":"enum","enums":["tag"]},{"dataType":"enum","enums":["genre"]},{"dataType":"enum","enums":["artist"]}],"required":true},"name":{"dataType":"string","required":true},"createdAt":{"dataType":"string","required":true}},"additionalProperties":false},
    ...
    "CreateMessageDto": {"dataType":"refObject","properties":{"content":{"dataType":"union","subSchemas":[{"dataType":"string"},{"dataType":"enum","enums":[null]}]},"media_ids":{"dataType":"union","subSchemas":[{"dataType":"array","array":{"dataType":"string"}},{"dataType":"enum","enums":[null]}]},"reply_to_message_id":{"dataType":"union","subSchemas":[{"dataType":"string"},{"dataType":"enum","enums":[null]}]}},"additionalProperties":false},
    "UpdateMessageDto": {"dataType":"refObject","properties":{"content":{"dataType":"string","required":true}},"additionalProperties":false},
    "FeedPostResponse": {"dataType":"refObject","properties":{"likesCount":{"dataType":"double"},"commentsCount":{"dataType":"double"},"bookmarksCount":{"dataType":"double"},"hasLiked":{"dataType":"boolean"},"hasBookmarked":{"dataType":"boolean"}},"additionalProperties":false},
    ...
    "CreateConversationDto": {"dataType":"refObject","properties":{"type":{"ref":"ConversationType","required":true},"avatar_url":{"dataType":"union","subSchemas":[{"dataType":"string"},{"dataType":"enum","enums":[null]}]},"name":{"dataType":"union","subSchemas":[{"dataType":"string"},{"dataType":"enum","enums":[null]}]},"participant_ids":{"dataType":"array","array":{"dataType":"string"},"required":true}},"additionalProperties":false},
    "UpdateConversationDto": {"dataType":"refObject","properties":{"name":{"dataType":"union","subSchemas":[{"dataType":"string"},{"dataType":"enum","enums":[null]}]},"avatar_url":{"dataType":"union","subSchemas":[{"dataType":"string"},{"dataType":"enum","enums":[null]}]}},"additionalProperties":false},
    ...
    "CreateConnectionRequestDto": {"dataType":"refObject","properties":{"recipient_id":{"dataType":"string","required":true}},"additionalProperties":false},
    ...
    "CreateCommentDto": {"dataType":"refObject","properties":{"content":{"dataType":"string","required":true},"post_id":{"dataType":"string","required":true}},"additionalProperties":false},
    ...
    "CreateCollaborationDto": {"dataType":"refObject","properties":{"description":{"dataType":"union","subSchemas":[{"dataType":"string"},{"dataType":"enum","enums":[null]}]},"collaborator_id":{"dataType":"string","required":true}},"additionalProperties":false},
    ...
    "CreateBookmarkDto": {"dataType":"refObject","properties":{"post_id":{"dataType":"string","required":true}},"additionalProperties":false},
