...
export interface paths {
    ...
    "/conversations/{conversationId}": {
         ...
         * @description Delete a conversation or leave a group
         *
...
export interface components {
    schemas: {
        ...
        /** @description From T, pick a set of properties whose keys are in the union K */
        "Pick_MessageInsert.Exclude_keyofMessageInsert.sender_id-or-conversation_id-or-created_at-or-id-or-is_edited-or-edited_at-or-is_deleted-or-deleted_at-or-sent_via_websocket__": {
            content?: string;
            media_ids?: string[];
            reply_to_message_id?: string;
        };
        /**
         * @description DTO for creating a message
         *
        ...
        CreateMessageDto: {
            ...
            reply_to_message_id?: string;
            /**
             * @description Array of media IDs to attach to the message
             * @example [
             *       "media-id-1",
             *       "media-id-2"
             *     ]
        ...
        /**
         * @description DTO for updating a message
         *
        ...
        /** @description From T, pick a set of properties whose keys are in the union K */
        "Pick_ConversationInsert.Exclude_keyofConversationInsert.created_by-or-created_at-or-updated_at-or-id-or-last_message_id-or-last_message_preview-or-last_message_at__": {
            /** @enum {string} */
            type: "direct" | "group";
            avatar_url?: string;
            name?: string;
        ...
        /**
         * @description DTO for creating a conversation
         *
        ...
        CreateConversationDto: {
            ...
            avatar_url?: string;
            /**
             * @description Optional name for the conversation (required for groups)
             * @example Band Practice
             */
            name?: string | null;
            /**
             * @description Optional avatar URL for group conversations
             * @example https://example.com/avatar.jpg
             */
            avatarUrl?: string | null;
            /**
             * @description Array of user IDs to add as participants (excluding the creator)
        ...
        UpdateConversationDto: {
            ...
            name?: string | null;
            /**
             * @description Updated avatar URL for the conversation
...
export interface operations {
    ...
    GetConversationMessages: {
        parameters: {
            query?: {
                ...
                limit?: number;
                /** @description If true, fetch messages before the cursor (for loading older messages) */
                before?: boolean;
            };
            header?: never;
            path: {
        ...
        requestBody?: never;
        responses: {
            /** @description Messages with pagination cursor */
            200: {
                headers: {
                    [name: string]: unknown;
                };
    ...
    CreateMessage: {
        ...
        /** @description Message data including content, optional media, and optional reply */
        requestBody: {
            content: {
        ...
        responses: {
            /** @description The created message with all relations */
            200: {
                headers: {
                    [name: string]: unknown;
                };
    ...
    GetMessage: {
        ...
        requestBody?: never;
        responses: {
            /** @description The message with all relations */
            200: {
                headers: {
                    [name: string]: unknown;
                };
    ...
    GetConversations: {
        ...
        requestBody?: never;
        responses: {
            /** @description Array of conversations with creator and participants */
            200: {
                headers: {
                    [name: string]: unknown;
                };
    ...
    CreateConversation: {
        ...
        /** @description Conversation data including type, name (for groups), and participant IDs */
        requestBody: {
            content: {
        ...
        responses: {
            /** @description The created conversation with creator and participants */
            200: {
                headers: {
                    [name: string]: unknown;
                };
    ...
    GetConversation: {
        ...
        requestBody?: never;
        responses: {
            /** @description The conversation with creator and participants */
            200: {
                headers: {
                    [name: string]: unknown;
                };
    ...
    UpdateConversation: {
        ...
        /** @description Updated conversation data (name, avatar_url) */
        requestBody: {
            content: {
    ...
    DeleteConversation: {
        parameters: {
            ...
            header?: never;
            path: {
                /** @description The UUID of the conversation to delete/leave */
                conversationId: string;
            };
            cookie?: never;
        };
