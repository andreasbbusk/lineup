	...
	return (
		<Tabs variant="profile" activeTab={activeTab} onTabChange={setActiveTab}>
			<TabsContent value="about">
				...
				{/* Social Media section */}
				<section className="flex flex-col items-start gap-[0.9375rem] self-stretch">
					<h4 className="font-normal text-[var(--color-grey)]">Social Media</h4>
									...
									<li key={i} className="flex items-center justify-center">
										{social ? (
											<Link
												...
												<Image
													src={socialMediaIcons[social.platform.toLowerCase()]}
													alt={social.platform}
													width={40}
													height={40}
												/>
							...
							{showAllArtists ? (
								...
								<div className="flex items-center gap-[1.0625rem]">
									<ul className="flex py-0 items-center">
										{props.favoriteArtists.slice(0, 3).map((artist, index) => (
...
/* <ProfileBody
	bio="I am a passionate musician with a love for creating unique sounds."
