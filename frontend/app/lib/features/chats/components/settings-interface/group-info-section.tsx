      ...
      <div className="relative">
        ...
        {isCreator && (
          <button
            ...
            className="absolute bottom-0 right-0 size-8 bg-dark-cyan-blue text-white rounded-full flex items-center justify-center active:scale-95 transition-transform"
